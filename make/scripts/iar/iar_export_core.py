...
def generateIpcf(inFile, outFile, generateCoreSuffix):
    """
    ...
    #Expected format for Cypress devices is {MPN-name}{Core}
...
def run_export(generateCoreSuffix):
    ...
    try:
        generateIpcf(args.inFile, args.outFile, generateCoreSuffix)
